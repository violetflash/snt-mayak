...
const phoneIcon =
    <svg className={s.Info__phoneIcon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 405.333 405.333">
        <path className={s.Info__phonePath} d="M373.333,266.88c-25.003,0-49.493-3.904-72.725-11.584c-11.328-3.904-24.171-0.896-31.637,6.699l-46.016,34.752
...
const Info = () => {
    return (
        <div className={s.Info}>
            <span className={s.Info__title}>Председатель</span>
            <a className={s.Info__phone} href="tel:123456789">
                {phoneIcon}
